package com.joyful.java.grpc.calculator.server;
...
public class CalculatorServiceImpl extends CalculatorServiceGrpc.CalculatorServiceImplBase {
    ...
    @Override
    public void primeNumberDecomposition(PrimeNumberDecomositionRequest request, StreamObserver<PrimeNumberDecompositionResponse> responseObserver) {
    ...
    @Override
    public void sqareRoot(SquareRootRequest request, StreamObserver<SquareRootResponse> responseObserver) {
        Integer number = 0;
        ...
        if (number >= 0) {
            ...
            responseObserver.onError(
                    Status
                            ...
                            .augmentDescription("The number " + number + " was sent.")
                            .asRuntimeException()
            );
        }
