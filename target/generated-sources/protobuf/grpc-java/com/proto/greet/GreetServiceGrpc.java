...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.greet.GreetWithDeathlineRequest,
      com.proto.greet.GreetWithDeathlineResponse> getGreetWithDeathlineMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GreetWithDeathline",
      requestType = com.proto.greet.GreetWithDeathlineRequest.class,
      responseType = com.proto.greet.GreetWithDeathlineResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.greet.GreetWithDeathlineRequest,
      com.proto.greet.GreetWithDeathlineResponse> getGreetWithDeathlineMethod() {
    io.grpc.MethodDescriptor<com.proto.greet.GreetWithDeathlineRequest, com.proto.greet.GreetWithDeathlineResponse> getGreetWithDeathlineMethod;
    if ((getGreetWithDeathlineMethod = GreetServiceGrpc.getGreetWithDeathlineMethod) == null) {
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetWithDeathlineMethod = GreetServiceGrpc.getGreetWithDeathlineMethod) == null) {
          GreetServiceGrpc.getGreetWithDeathlineMethod = getGreetWithDeathlineMethod =
              io.grpc.MethodDescriptor.<com.proto.greet.GreetWithDeathlineRequest, com.proto.greet.GreetWithDeathlineResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GreetWithDeathline"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.greet.GreetWithDeathlineRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.greet.GreetWithDeathlineResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GreetServiceMethodDescriptorSupplier("GreetWithDeathline"))
              .build();
        }
      }
    }
    return getGreetWithDeathlineMethod;
  }
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greetWithDeathline(com.proto.greet.GreetWithDeathlineRequest request,
        io.grpc.stub.StreamObserver<com.proto.greet.GreetWithDeathlineResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGreetWithDeathlineMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getGreetWithDeathlineMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.proto.greet.GreetWithDeathlineRequest,
                com.proto.greet.GreetWithDeathlineResponse>(
                  this, METHODID_GREET_WITH_DEATHLINE)))
          .build();
    }
  }
  ...
  public static final class GreetServiceStub extends io.grpc.stub.AbstractAsyncStub<GreetServiceStub> {
    ...
    public void greetWithDeathline(com.proto.greet.GreetWithDeathlineRequest request,
        io.grpc.stub.StreamObserver<com.proto.greet.GreetWithDeathlineResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGreetWithDeathlineMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetServiceBlockingStub> {
    ...
    /**
     */
    public com.proto.greet.GreetWithDeathlineResponse greetWithDeathline(com.proto.greet.GreetWithDeathlineRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGreetWithDeathlineMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.greet.GreetWithDeathlineResponse> greetWithDeathline(
        com.proto.greet.GreetWithDeathlineRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGreetWithDeathlineMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GREET = 0;
  private static final int METHODID_GREET_MANY_TIMES = 1;
  private static final int METHODID_GREET_WITH_DEATHLINE = 2;
      ...
      switch (methodId) {
        ...
        case METHODID_GREET_MANY_TIMES:
          serviceImpl.greetManyTimes((com.proto.greet.GreetManytimesRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.greet.GreetManytimesResponse>) responseObserver);
          break;
        case METHODID_GREET_WITH_DEATHLINE:
          serviceImpl.greetWithDeathline((com.proto.greet.GreetWithDeathlineRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.greet.GreetWithDeathlineResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (GreetServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGreetWithDeathlineMethod())
              .build();
        }
      }
    }
