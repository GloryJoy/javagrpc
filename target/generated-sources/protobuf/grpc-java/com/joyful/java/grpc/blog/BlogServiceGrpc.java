...
public final class BlogServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.CreateBlogRequest,
      com.joyful.java.grpc.blog.CreateBlogResponse> getCreateBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateBlog",
      requestType = com.joyful.java.grpc.blog.CreateBlogRequest.class,
      responseType = com.joyful.java.grpc.blog.CreateBlogResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.CreateBlogRequest,
      com.joyful.java.grpc.blog.CreateBlogResponse> getCreateBlogMethod() {
    io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.CreateBlogRequest, com.joyful.java.grpc.blog.CreateBlogResponse> getCreateBlogMethod;
      ...
      synchronized (BlogServiceGrpc.class) {
        if ((getCreateBlogMethod = BlogServiceGrpc.getCreateBlogMethod) == null) {
          BlogServiceGrpc.getCreateBlogMethod = getCreateBlogMethod =
              io.grpc.MethodDescriptor.<com.joyful.java.grpc.blog.CreateBlogRequest, com.joyful.java.grpc.blog.CreateBlogResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.joyful.java.grpc.blog.CreateBlogRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.ReadBlogRequest,
      com.joyful.java.grpc.blog.ReadBlogResponse> getReadBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReadBlog",
      requestType = com.joyful.java.grpc.blog.ReadBlogRequest.class,
      responseType = com.joyful.java.grpc.blog.ReadBlogResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.ReadBlogRequest,
      com.joyful.java.grpc.blog.ReadBlogResponse> getReadBlogMethod() {
    io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.ReadBlogRequest, com.joyful.java.grpc.blog.ReadBlogResponse> getReadBlogMethod;
    if ((getReadBlogMethod = BlogServiceGrpc.getReadBlogMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getReadBlogMethod = BlogServiceGrpc.getReadBlogMethod) == null) {
          BlogServiceGrpc.getReadBlogMethod = getReadBlogMethod =
              io.grpc.MethodDescriptor.<com.joyful.java.grpc.blog.ReadBlogRequest, com.joyful.java.grpc.blog.ReadBlogResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReadBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.joyful.java.grpc.blog.ReadBlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.UpdateBlogRequest,
      com.joyful.java.grpc.blog.UpdateBlogResponse> getUpdateBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateBlog",
      requestType = com.joyful.java.grpc.blog.UpdateBlogRequest.class,
      responseType = com.joyful.java.grpc.blog.UpdateBlogResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.UpdateBlogRequest,
      com.joyful.java.grpc.blog.UpdateBlogResponse> getUpdateBlogMethod() {
    io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.UpdateBlogRequest, com.joyful.java.grpc.blog.UpdateBlogResponse> getUpdateBlogMethod;
    if ((getUpdateBlogMethod = BlogServiceGrpc.getUpdateBlogMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getUpdateBlogMethod = BlogServiceGrpc.getUpdateBlogMethod) == null) {
          BlogServiceGrpc.getUpdateBlogMethod = getUpdateBlogMethod =
              io.grpc.MethodDescriptor.<com.joyful.java.grpc.blog.UpdateBlogRequest, com.joyful.java.grpc.blog.UpdateBlogResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.joyful.java.grpc.blog.UpdateBlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.DeleteBlogRequest,
      com.joyful.java.grpc.blog.DeleteBlogResponse> getDeleteBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DeleteBlog",
      requestType = com.joyful.java.grpc.blog.DeleteBlogRequest.class,
      responseType = com.joyful.java.grpc.blog.DeleteBlogResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.DeleteBlogRequest,
      com.joyful.java.grpc.blog.DeleteBlogResponse> getDeleteBlogMethod() {
    io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.DeleteBlogRequest, com.joyful.java.grpc.blog.DeleteBlogResponse> getDeleteBlogMethod;
    if ((getDeleteBlogMethod = BlogServiceGrpc.getDeleteBlogMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getDeleteBlogMethod = BlogServiceGrpc.getDeleteBlogMethod) == null) {
          BlogServiceGrpc.getDeleteBlogMethod = getDeleteBlogMethod =
              io.grpc.MethodDescriptor.<com.joyful.java.grpc.blog.DeleteBlogRequest, com.joyful.java.grpc.blog.DeleteBlogResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DeleteBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.joyful.java.grpc.blog.DeleteBlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.ListBlogRequest,
      com.joyful.java.grpc.blog.ListBlogResponse> getListBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListBlog",
      requestType = com.joyful.java.grpc.blog.ListBlogRequest.class,
      responseType = com.joyful.java.grpc.blog.ListBlogResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.ListBlogRequest,
      com.joyful.java.grpc.blog.ListBlogResponse> getListBlogMethod() {
    io.grpc.MethodDescriptor<com.joyful.java.grpc.blog.ListBlogRequest, com.joyful.java.grpc.blog.ListBlogResponse> getListBlogMethod;
    if ((getListBlogMethod = BlogServiceGrpc.getListBlogMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getListBlogMethod = BlogServiceGrpc.getListBlogMethod) == null) {
          BlogServiceGrpc.getListBlogMethod = getListBlogMethod =
              io.grpc.MethodDescriptor.<com.joyful.java.grpc.blog.ListBlogRequest, com.joyful.java.grpc.blog.ListBlogResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.joyful.java.grpc.blog.ListBlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class BlogServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createBlog(com.joyful.java.grpc.blog.CreateBlogRequest request,
        io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.CreateBlogResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateBlogMethod(), responseObserver);
    }

    /**
     */
    public void readBlog(com.joyful.java.grpc.blog.ReadBlogRequest request,
        io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.ReadBlogResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getReadBlogMethod(), responseObserver);
    }

    /**
     */
    public void updateBlog(com.joyful.java.grpc.blog.UpdateBlogRequest request,
        io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.UpdateBlogResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUpdateBlogMethod(), responseObserver);
    }

    /**
     */
    public void deleteBlog(com.joyful.java.grpc.blog.DeleteBlogRequest request,
        io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.DeleteBlogResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteBlogMethod(), responseObserver);
    }

    /**
     */
    public void listBlog(com.joyful.java.grpc.blog.ListBlogRequest request,
        io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.ListBlogResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.joyful.java.grpc.blog.CreateBlogRequest,
                com.joyful.java.grpc.blog.CreateBlogResponse>(
                  this, METHODID_CREATE_BLOG)))
          .addMethod(
            getReadBlogMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.joyful.java.grpc.blog.ReadBlogRequest,
                com.joyful.java.grpc.blog.ReadBlogResponse>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                com.joyful.java.grpc.blog.UpdateBlogResponse>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                com.joyful.java.grpc.blog.DeleteBlogResponse>(
                  this, METHODID_DELETE_BLOG)))
          .addMethod(
            getListBlogMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.joyful.java.grpc.blog.ListBlogRequest,
                com.joyful.java.grpc.blog.ListBlogResponse>(
  ...
  public static final class BlogServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BlogServiceBlockingStub> {
    ...
    /**
     */
    public com.joyful.java.grpc.blog.CreateBlogResponse createBlog(com.joyful.java.grpc.blog.CreateBlogRequest request) {
    ...
    /**
     */
    public com.joyful.java.grpc.blog.ReadBlogResponse readBlog(com.joyful.java.grpc.blog.ReadBlogRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public com.joyful.java.grpc.blog.UpdateBlogResponse updateBlog(com.joyful.java.grpc.blog.UpdateBlogRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public com.joyful.java.grpc.blog.DeleteBlogResponse deleteBlog(com.joyful.java.grpc.blog.DeleteBlogRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public java.util.Iterator<com.joyful.java.grpc.blog.ListBlogResponse> listBlog(
  ...
  public static final class BlogServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BlogServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.joyful.java.grpc.blog.CreateBlogResponse> createBlog(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.joyful.java.grpc.blog.ReadBlogResponse> readBlog(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.joyful.java.grpc.blog.UpdateBlogResponse> updateBlog(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.joyful.java.grpc.blog.DeleteBlogResponse> deleteBlog(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BLOG:
          serviceImpl.createBlog((com.joyful.java.grpc.blog.CreateBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.CreateBlogResponse>) responseObserver);
          break;
        case METHODID_READ_BLOG:
          serviceImpl.readBlog((com.joyful.java.grpc.blog.ReadBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.ReadBlogResponse>) responseObserver);
          break;
        case METHODID_UPDATE_BLOG:
          serviceImpl.updateBlog((com.joyful.java.grpc.blog.UpdateBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.UpdateBlogResponse>) responseObserver);
          break;
        case METHODID_DELETE_BLOG:
          serviceImpl.deleteBlog((com.joyful.java.grpc.blog.DeleteBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.DeleteBlogResponse>) responseObserver);
          break;
        case METHODID_LIST_BLOG:
          serviceImpl.listBlog((com.joyful.java.grpc.blog.ListBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.joyful.java.grpc.blog.ListBlogResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BlogServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.joyful.java.grpc.blog.BlogOuterClass.getDescriptor();
    }
